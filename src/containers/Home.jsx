    ...
    <div className="font-sans text-gray-900">
      ...
      <HeroSection
        ...
        Използваме комбинирания авторефрактометър и автокератометър Charops CRK-1P, разработен по иновативна технология от Huvitz, Корея.}}
         ...
         [[Авторефрактометърът]] прецизно измерва рефракцията на очите – ключов елемент при определяне на точната диоптрия.
         [[Автокератометърът]] анализира кривината на роговицата – изключително важен за изписване на очила и адаптиране на контактни лещи.
      ...
      />
       ...
       <HeroSection
        ...
        text={`Прегледът се извършва от Дочка Пеева – дипломиран оптометрист с доказан професионализъм и индивидуален подход към всеки пациент.
